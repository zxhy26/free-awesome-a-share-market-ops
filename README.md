...
Current open-source version: `2.19.0`.

## Features

- A persistent, searchable 19-index catalog with up to eight user-selected real intraday charts in a stable four-by-two desktop grid
