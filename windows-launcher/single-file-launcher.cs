...
internal static class Program
{
    ...
    private const string RuntimeTag = "版本_20260728-2.17.3-基础版";
    private const string MutexName = "Local\\AshareReviewLauncher_Basic_21703";
#elif SELF_EDITION
    private const string EditionName = "自用版";
    private const string EditionCode = "self";
    private const string RuntimeTag = "版本_20260728-2.17.3-自用版";
    private const string MutexName = "Local\\AshareReviewLauncher_Self_21703";
#else
    private const string EditionName = "会员版";
    private const string EditionCode = "member";
    private const string RuntimeTag = "版本_20260728-2.17.3-会员版";
    private const string MutexName = "Local\\AshareReviewLauncher_Member_21703";
#endif
