...
[assembly: AssemblyVersion("2.17.4.0")]
[assembly: AssemblyFileVersion("2.17.4.0")]
...
internal static class Program
{
    ...
    private const string RuntimeTag = "版本_20260728-2.17.4-基础版";
    private const string MutexName = "Local\\AshareReviewLauncher_Basic_21704";
#elif SELF_EDITION
    private const string EditionName = "自用版";
    private const string EditionCode = "self";
    private const string RuntimeTag = "版本_20260728-2.17.4-自用版";
    private const string MutexName = "Local\\AshareReviewLauncher_Self_21704";
#else
    private const string EditionName = "会员版";
    private const string EditionCode = "member";
    private const string RuntimeTag = "版本_20260728-2.17.4-会员版";
    private const string MutexName = "Local\\AshareReviewLauncher_Member_21704";
#endif
