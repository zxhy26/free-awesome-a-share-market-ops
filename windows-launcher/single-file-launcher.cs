...
internal static class Program
{
    ...
    private const string RuntimeTag = "版本_20260731-2.19.2-基础版-财联社指数标注";
    private const string MutexName = "Local\\AshareReviewLauncher_Basic_21920";
#elif SELF_EDITION
    private const string EditionName = "自用版";
    private const string EditionCode = "self";
    private const string RuntimeTag = "版本_20260731-2.19.2-自用版-财联社指数标注";
    private const string MutexName = "Local\\AshareReviewLauncher_Self_21920";
#elif CUSTOM_EDITION
    private const string EditionName = "定制版";
    private const string EditionCode = "basic";
    private const string RuntimeTag = "版本_20260731-2.19.2-定制版-财联社指数标注";
    private const string MutexName = "Local\\AshareReviewLauncher_Custom_21920";
#else
    private const string EditionName = "会员版";
    private const string EditionCode = "member";
    private const string RuntimeTag = "版本_自动更新-会员版";
    private const string MutexName = "Local\\AshareReviewLauncher_Member_21920";
#endif
    private const string LauncherVersion = "2.19.2";
